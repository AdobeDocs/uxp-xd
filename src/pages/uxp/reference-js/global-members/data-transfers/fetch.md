...
description: 1. when init.body is set and init.method is either 'GET' or 'HEAD'.
---
...
| \[init.body] | `string` \| `ArrayBuffer` \| `TypedArray` \| `FormData` |  | the body that is included in the HTTP request body. There is a caveat for sending a FormData object. see [XMLHttpRequest.send](../../global-members/data-transfers/xml-http-request.md#module:global.xmlhttprequest.send). |
