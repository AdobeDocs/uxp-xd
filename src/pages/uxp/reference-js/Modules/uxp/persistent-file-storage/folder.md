---
jsDoc: true
title: require('uxp').storage.Folder
...
but will get it by calling [FileSystemProvider.getTemporaryFolder](/uxp/reference-js/Modules/uxp/persistent-file-storage/file-system-provider.md#module-storage-filesystemprovider-gettemporaryfolder),
[FileSystemProvider.getFolder](/uxp/reference-js/Modules/uxp/persistent-file-storage/file-system-provider.md#module-storage-filesystemprovider-getfolder),
or via [Folder.getEntries](/uxp/reference-js/Modules/uxp/persistent-file-storage/folder.md#module-storage-folder-getentries).
