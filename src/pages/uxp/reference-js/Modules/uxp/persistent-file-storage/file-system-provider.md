---
jsDoc: true
title: require('uxp').storage.FileSystemProvider
description: Provides access to files and folders on a file system. You'll never
---
...
[userDocuments](/uxp/reference-js/Modules/uxp/persistent-file-storage/domains.md#module-storage-domains-userdocuments) will be in this list.
...
and folders within can be accessed via [Folder#getEntries](/uxp/reference-js/Modules/uxp/persistent-file-storage/folder.md#module-storage-folder-getentries). Any
