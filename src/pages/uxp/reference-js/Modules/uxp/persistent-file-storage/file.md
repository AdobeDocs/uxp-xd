---
jsDoc: true
title: require('uxp').storage.File
...
you'll get access via a [storage.FileSystemProvider](/uxp/reference-js/Modules/uxp/persistent-file-storage/file-system-provider.md).
...
## mode : `Symbol`
Indicates whether this file is read-only or read-write. See [readOnly](../../../modules/uxp/persistent-file-storage/modes.md#readonly) and [readWrite](../../../modules/uxp/persistent-file-storage/modes.md#readwrite).
...
| --- | --- | --- | --- |
| options | `any` |  |  |
| \[options.format] | `Symbol` | `formats.utf8` | The format of the file; see [utf8](../../../modules/uxp/persistent-file-storage/formats.md#utf8) and [binary](../../../modules/uxp/persistent-file-storage/formats.md#binary). |
