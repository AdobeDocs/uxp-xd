...
jsDoc: true
title: sp-dropdown
description: Renders a dropdown with menu items. The dropdown must contain a sp-menu with slot='options', and inside the sp-menu, a series of sp-menu-item or...
---
# sp-dropdown

**Since:** UXP v4.1

Renders a dropdown with menu items. The dropdown must contain a [sp-menu](/uxp/reference-spectrum/user-interface/sp-menu.md) with `slot="options"`, and inside the `sp-menu`, a series of `sp-menu-item` or `sp-menu-divider` elements.
