...
4. **Plugin icons**: Make sure you include required icons for both the plugin and its panels, if any. If all icons aren't included, your plugin will be rejected during review (but submission will succeed). See [the manifest docs for more info](/guides/uxp-misc/manifest-v4/).
