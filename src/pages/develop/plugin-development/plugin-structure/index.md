...
keywords:
  ...
  - UXP
  - Plugin
description: "One folder and two files: that's all it takes to create an XD plugin!"
---
...
- [Plugin Menu Structure](/develop/plugin-development/plugin-structure/menu-structure.md)