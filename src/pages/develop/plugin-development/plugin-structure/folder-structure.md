...
keywords:
  ...
  - UXP
  - Plugin
description: "When you have the right structure for your XD plugin, it will look like this:"
---
...
1.  `manifest.json` is your plugin’s manifest.
    ...
    ```text
     This file is where you include _facts_ about your plugin, such as its name, the menu item(s) it adds to XD, and so
     on. [Learn about the manifest here](/develop/plugin-development/plugin-structure/manifest.md).
    ```

1.  `main.js` is your plugin’s code.

    ```text
    This file contains your JavaScript code that implements the logic for your plugin. [Learn more about `main.js` here]
    (/develop/plugin-development/plugin-structure/handlers.md).
    ```
