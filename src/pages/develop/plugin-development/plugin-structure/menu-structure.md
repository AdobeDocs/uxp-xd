---
title: Plugin menu structure
keywords:
  - Creative Cloud
  - API Documentation
  - UXP
  - Plugin
description: In your manifest.json(/develop/plugin-development/plugin-structure/manifest.md), the `entryPoints` field is an array of objects including all UI ent
---
