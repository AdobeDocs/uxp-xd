...
keywords:
  ...
  - UXP
  - Plugin
description: Every _UI entry point_ you declare in `manifest.json`(/develop/plugin-development/plugin-structure/manifest.md) must be fulfilled by a definition ex
---
