...
## Application
An XD-specific namespace that provides access to various methods that aren't specific to the XD document. [Read more](/reference/application/).
...
## Edit Context
Represents the context within which a plugin or user is allowed to make edits to the user's scenegraph. [Read more](/reference/core/edit-context/).
...
## ImageFill
Used to fill a SceneNode with bitmap data. [Read more](/reference/ImageFill/)
...
## Manifest
A manifest is used to declare various facts about a plugin. For example, a manifest includes the plugin's name, a unique ID, and what functions correspond with what menu items. [Read more](/reference/structure/manifest/).

## Node
A tree node. Depending on context, this node may refer to a [HTML5 DOM Node](/reference/uxp/class/Node/) or an [XD Scenegraph node](/reference/scenegraph/#scenenode).
...
## SceneNode
A [SceneNode](/reference/scenegraph/#scenenode) represents a node within the user's scenegraph.

## Scenegraph
A scenegraph represents the user's document. It is so called because it is a tree (a kind of graph) of nodes that, when taken together, represents the entire "scene" of the document. Adobe XD [provides an API](/reference/scenegraph/) for manipulating the scenegraph. [Learn more about the scenegraph](/reference/core/scenegraph/).

## SceneNodeList
A list of scene nodes. [Read more](/reference/SceneNodeList/)
...
## XMLHttpRequest
An network I/O API that can be used to request information from local and remote endpoints. [See documentation](/reference/uxp/class/XMLHttpRequest/).

## WebSocket
A network I/O API that enables real-time communication with local and remote endpoints. [See documentation](/reference/uxp/class/WebSocket/).
