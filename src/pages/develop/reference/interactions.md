...
keywords:
  ...
  - UXP
  - Plugin
description: "Since: XD 19+ (some APIs added later)"
---
...
NOTE: All `url` returned via [flows](#flows) are related to published flows and are usually a subset of the URLs returned via [getSharedArtifacts](/develop/reference/cloud.md#getsharedartifacts). However, the reverse may or may not always hold true.
...
**Deprecated**: XD 33 - Please use [flows](#flows) which supports multple flows.
