...
keywords:
  ...
  - UXP
  - Plugin
description: Represents the document styles listed in the Assets panel. Styles can be added and removed manually by the user, so
---
...
\<dl\>
\<dt\> GradientType : \</dt\>\<dd\>LINEAR, RADIAL - Type of gradient color element: linear gradient or radial gradient\</dd\>
\</dl\>
