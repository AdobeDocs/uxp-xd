...
keywords:
  ...
  - Plugin
title: RootNode
description: Class representing the root node of the document. All Artboards are children of this node, as well as any pasteboard content that
---
...
| ----- | ------------ | --------------------------------------------------------------------------------------------------------- |
| node  | [SceneNode](/develop/reference/scene-node.md) | Child to add |
...
| ---------- | ------------ | -------------------------------------------------------- |
| node       | [SceneNode](/develop/reference/scene-node.md) | Child to add                                             |
| relativeTo | [SceneNode](/develop/reference/scene-node.md) | New child is added immediately after this existing child |
...
| ---------- | ------------ | --------------------------------------------------------- |
| node       | [SceneNode](/develop/reference/scene-node.md) | Child to add                                              |
| relativeTo | [SceneNode](/develop/reference/scene-node.md) | New child is added immediately before this existing child |
