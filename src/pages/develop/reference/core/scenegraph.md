...
Typically, you access scenegraph nodes via the [`selection`](/reference/selection/) argument that is passed to your plugin command.
...
this, instead use [commands](/reference/commands/).