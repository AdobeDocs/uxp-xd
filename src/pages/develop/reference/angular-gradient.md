...
description: In an angular  gradient, colors blend together in a sweeping pattern around a shape from the center of a circle. The gradient fills the entire area of the...
---
