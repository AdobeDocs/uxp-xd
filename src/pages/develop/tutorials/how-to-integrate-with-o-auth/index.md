...
description: This tutorial will show you how to implement the OAuth workflow in an XD plugin, using the Dropbox API as an example.
---
...
- [A registered app on Dropbox](https://www.dropbox.com/developers/apps/create) with the following settings:
  ...
  1.  In `Redirect URIs`, add your own `https` `ngrok` URL (example: "[https://476322de.ngrok.io/callback](https://476322de.ngrok.io/callback)") or a secure public URL if you have one
